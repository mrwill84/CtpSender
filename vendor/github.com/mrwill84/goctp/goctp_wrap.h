...
class SwigDirector_CThostFtdcTraderSpi : public CThostFtdcTraderSpi
{
 public:
  ...
  void _swig_upcall_OnRspQueryMaxOrderVolume(CThostFtdcQueryMaxOrderVolumeField *pQueryMaxOrderVolume, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
